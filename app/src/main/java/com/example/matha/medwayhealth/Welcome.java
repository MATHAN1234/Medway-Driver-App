...
public class Welcome extends Fragment implements OnMapReadyCallback{
        ...
        loc_switch.setOnCheckedChangeListener(new MaterialAnimatedSwitch.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(boolean isOnline) {
                if (isOnline) {
                    ...
                    if (ActivityCompat.checkSelfPermission(Welcome.this.getContext(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                            ActivityCompat.checkSelfPermission(Welcome.this.getContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED){
                        return;
                    }
...
*/
        ...
        try{
            ...
            mServices.getPath(requestApi).enqueue(new Callback<String>() {
                ...
                public void onFailure(Call<String> call, Throwable throwable) {
                    Toast.makeText(Welcome.this.getContext(), ""+throwable.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
        catch(Exception e){
    ...
    private void setUpLocation() {
        if (ActivityCompat.checkSelfPermission(this.getContext(), Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this.getContext(), Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            ActivityCompat.requestPermissions(this.getActivity(),new String[]{Manifest.permission.ACCESS_COARSE_LOCATION,Manifest.permission.ACCESS_FINE_LOCATION
